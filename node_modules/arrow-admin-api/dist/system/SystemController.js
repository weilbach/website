...
var SystemController = function () {
  ...
  * @return {string} config.productVersion - The product name.
  * @return {string} config.platformServerUrl - The platform server URL.
  * @return {string} config.apiPrefix - The url prefix for API requests.
  * @return {string} config.dateTimeFormat - Datetime format for the logging purpose.
  */
