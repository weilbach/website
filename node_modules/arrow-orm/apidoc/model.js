 ...
 * @class Arrow.Model
 *
 * The API Builder Model API provides an interface to programmatically access
 * Models from an API Builder application.  Models provide an interface to access
 * data (or Model Instances) from an [API Builder Connector](https://docs.axway.com/bundle/API_Builder_allOS_en/page/api_builder_connectors.html).
 *
 * The Model API is divided into two APIs:
 *
 *   * Use the API Builder Model API to manage the Model class (or the interface to the Models)
 *   * Use the [API Builder Instance API](http://docs.appcelerator.com/platform/latest/#!/api/Arrow.Instance) to manage the Model records (or the data in
 *   model)
 *
 ...
 *
 * To automatically generate the standardized APIs, add the model to the API Builder instance before invoking
 * the API Builder instance's `start()` method.
 *
 * For example:
 *
 ...
 * API Builder project.  For details, see the
 * [API Builder Models guide](https://docs.axway.com/bundle/API_Builder_allOS_en/page/api_builder_models.html).
 */
 ...
 * Standard query options used by API Builder for query requests.
 * @pseudo
 */
/**
 * @property [limit=10]
