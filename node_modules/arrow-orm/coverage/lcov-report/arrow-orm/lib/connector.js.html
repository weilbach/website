  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>279/339</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>276/335</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L755'></a><a href='#L755'>755</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >						console.error('Failed to load connector sub directory module; skipping it:');</span>
...
&nbsp;
	ConnectorConstructor.extend = <span class="fstat-no" title="function not covered" >fu</span>nction (extendingImpl) {
<span class="cstat-no" title="statement not covered" >		return classExtend(merge(impl, extendingImpl));</span>
	};
&nbsp;
 ...
 * @returns {Boolean}
 */
Connector.prototype.isConnected = function <span class="fstat-no" title="function not covered" >isConnected(</span>) {
...
<span class="cstat-no" title="statement not covered" >					return next(err);</span>
				...
				<span class="missing-if-branch" title="else path not taken" >E</span>if (schema) {
					this.metadata = merge(this.metadata || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span> { schema: schema });
					this.schema = schema;
				}
 ...
 * @returns {Void}
 */
Connector.prototype.disconnect = function <span class="fstat-no" title="function not covered" >disconnect(</span>callback) {
...
<span class="cstat-no" title="statement not covered" >		tasks.push(function <span class="fstat-no" title="function not covered" >disconnectTask(</span>next) {</span>
<span class="cstat-no" title="statement not covered" >			this._disconnect(next);</span>
		}.bind(this));
	}
<span class="cstat-no" title="statement not covered" >	async.series(tasks, function <span class="fstat-no" title="function not covered" >disconnectCallback(</span>err) {</span>
 ...
 */
Connector.prototype.getPrimaryKeyColumnName = function () {
 ...
 */
Connector.prototype.count = function <span class="fstat-no" title="function not covered" >count(</span>Model, options, callback) {
<span class="cstat-no" title="statement not covered" >	if (_.isFunction(options)) {</span>
<span class="cstat-no" title="statement not covered" >		callback = options;</span>
<span class="cstat-no" title="statement not covered" >		options = {};</span>
	}
<span class="cstat-no" title="statement not covered" >	this.query(Model, options, <span class="fstat-no" title="function not covered" >fu</span>nction (err, results) {</span>
<span class="cstat-no" title="statement not covered" >		if (err) {</span>
<span class="cstat-no" title="statement not covered" >			return callback(err);</span>
		} else {
			var count = <span class="cstat-no" title="statement not covered" >results.length;</span>
<span class="cstat-no" title="statement not covered" >			if (options.distinct) {</span>
				var found = <span class="cstat-no" title="statement not covered" >{};</span>
<span class="cstat-no" title="statement not covered" >				count = 0;</span>
<span class="cstat-no" title="statement not covered" >				for (var c = <span class="cstat-no" title="statement not covered" >0;</span> c &lt; results.length; c++) {</span>
					var row = <span class="cstat-no" title="statement not covered" >results[c],</span>
						value = <span class="cstat-no" title="statement not covered" >row.get(options.distinct);</span>
