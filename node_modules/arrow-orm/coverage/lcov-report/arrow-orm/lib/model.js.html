  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">81.04% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>530/654</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>526/649</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L1821'></a><a href='#L1821'>1821</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
Model.removeListener = function <span class="fstat-no" title="function not covered" >removeListener(</span>) {
 ...
 * @param  {Object} connector {Arrow.Connector}
 */
...
<span class="cstat-no" title="statement not covered" >					model.fields[name] = merge(_.cloneDeep(fields[name]), model.fields[name]);</span>
				} else {
...
Model.prototype.createAPI = function createAPI() {
	...
	return {
		...
		action: function <span class="fstat-no" title="function not covered" >createAction(</span>req, resp, next) {
...
Model.prototype.updateAPI = function updateAPI() {
	...
	return {
		...
		action: function <span class="fstat-no" title="function not covered" >updateAction(</span>req, resp, next) {
<span class="cstat-no" title="statement not covered" >			req.model.fetch(req.params.id, resp.createCallback(null, function <span class="fstat-no" title="function not covered" >putSuccessCallback(</span>model, cb) {</span>
<span class="cstat-no" title="statement not covered" >				try {</span>
...
<span class="cstat-no" title="statement not covered" >							return callback(err);</span>
						...
						<span class="missing-if-branch" title="if path not taken" >I</span>if (!_instance) {
<span class="cstat-no" title="statement not covered" >							return callback('trying to update, couldn\'t find record with primary key: ' + instance.id + ' for ' + this.name);</span>
						}
...
Model.prototype.deleteAPI = function deleteAPI() {
	return {
		...
		action: function <span class="fstat-no" title="function not covered" >deleteAction(</span>req, resp, next) {
<span class="cstat-no" title="statement not covered" >			try {</span>
...
<span class="cstat-no" title="statement not covered" >					return callback(err);</span>
				...
				<span class="missing-if-branch" title="if path not taken" >I</span>if (!_instance) {
<span class="cstat-no" title="statement not covered" >					return callback('trying to remove, couldn\'t find record with primary key: ' + instance + ' for ' + this.name);</span>
				}
...
Model.prototype.deleteAllAPI = function deleteAllAPI() {
	return {
		...
		action: function <span class="fstat-no" title="function not covered" >deleteAction(</span>req, resp, next) {
<span class="cstat-no" title="statement not covered" >			req.model.deleteAll(resp.createCallback(null, function <span class="fstat-no" title="function not covered" >delAllSuccessCallback(</span>count, cb) {</span>
...
Model.prototype.distinctAPI = function distinctAPI() {
	...
	result.action = function <span class="fstat-no" title="function not covered" >distinctAction(</span>req, resp, next) {
		var field = <span class="cstat-no" title="statement not covered" >req.params.field;</span>
...
Model.prototype.findByIDAPI = function findByIDAPI() {
	return {
		...
		action: function <span class="fstat-no" title="function not covered" >findByIDAction(</span>req, resp, next) {
<span class="cstat-no" title="statement not covered" >			try {</span>
 ...
 * @returns {Void}
 */
Model.prototype.findOne = <span class="fstat-no" title="function not covered" >fu</span>nction () {
	// Get connector's logger or fallbacks to console.warn if it not exists
	var connector = <span class="cstat-no" title="statement not covered" >this.getConnector();</span>
	var log = <span class="cstat-no" title="statement not covered" >connector.logger ? connector.logger.warn.bind(connector.logger) : console.warn.bind(console);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >			connector[Array.isArray(id) ? 'findManyById' : 'findById'](this, id, next);</span>
		} else {
<span class="cstat-no" title="statement not covered" >			connector[Array.isArray(id) ? 'findOneMany' : 'findOne'](this, id, next);</span>
		}
	} catch (E) {
<span class="cstat-no" title="statement not covered" >		return callback(E);</span>
	}
...
Model.prototype.findAndModifyAPI = function findAndModifyAPI() {
	...
	return {
		...
		action: function <span class="fstat-no" title="function not covered" >queryAction(</span>req, resp, next) {
<span class="cstat-no" title="statement not covered" >			try {</span>
...
Model.prototype.findAndModify = function findAndModify(options, doc, args, callback) {
	try {
		...
		var next = callback,
			cache = this.cache;
		<span class="missing-if-branch" title="if path not taken" >I</span>if (cache) {
<span class="cstat-no" title="statement not covered" >			next = <span class="fstat-no" title="function not covered" >fu</span>nction () {</span>
<span class="cstat-no" title="statement not covered" >				cache.reset();</span>
...
Model.prototype.findAllAPI = function findAllAPI() {
	return {
		...
		action: function <span class="fstat-no" title="function not covered" >findAllAction(</span>req, resp, next) {
<span class="cstat-no" title="statement not covered" >			try {</span>
		...
		if (cache) {
			...
			next = function (err, results) {
				<span class="missing-if-branch" title="else path not taken" >E</span>if (results) {
					...
					<span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(results)) {
...
Model.prototype.countAPI = function countAPI() {
	...
	result.action = function <span class="fstat-no" title="function not covered" >countAction(</span>req, resp, next) {
<span class="cstat-no" title="statement not covered" >		resp.stream(req.model.count, req.params, <span class="fstat-no" title="function not covered" >fu</span>nction (err, results) {</span>
...
<span class="cstat-no" title="statement not covered" >			options = {};</span>
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (cache &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >!options </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >Object.keys(options).length === 0)</span>) {
			var cached = <span class="cstat-no" title="statement not covered" >cache.get('count');</span>
...
<span class="cstat-no" title="statement not covered" >			next = <span class="fstat-no" title="function not covered" >fu</span>nction (err, results) {</span>
...
Model.prototype.upsertAPI = function upsertAPI() {
	...
	result.action = function <span class="fstat-no" title="function not covered" >upsertAction(</span>req, resp, next) {
<span class="cstat-no" title="statement not covered" >		try {</span>
...
Model.prototype.translateKeysForPayload = function translateKeysForPayload(obj) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if (obj &amp;&amp; typeof obj === 'string') {
<span class="cstat-no" title="statement not covered" >		try {</span>
...
<span class="cstat-no" title="statement not covered" >				for (var i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; val.length; i++) {</span>
...
<span class="cstat-no" title="statement not covered" >		options = merge(ctx.defaultQueryOptions, options);</span>
	}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu May 23 2019 16:16:46 GMT+0000 (UTC)
</div>
</div>
