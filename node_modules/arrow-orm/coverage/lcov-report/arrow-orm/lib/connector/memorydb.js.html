...
function fieldsToArray(fields) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof fields === 'string') {
<span class="cstat-no" title="statement not covered" >		return fields.split(',').map(<span class="fstat-no" title="function not covered" >fu</span>nction (f) {</span>
