/**
 * @class Arrow.Logger
 * The API Builder Logger class provides a wrapper for [bunyan](https://www.npmjs.com/package/bunyan),
 * a JSON logging utility. You can access a local instance of the log utility using the `logger`
 * property of the API Builder instance.
 */
 ...
 * @static
 * @param {Arrow} API Builder instance.
 * @param {Object} options Additional initialization options.
 * Refer to the [bunyan documentation](https://www.npmjs.com/package/bunyan).
 * @return {Arrow.Logger}
 */
