 ...
 * API Builder server's app instance.
 *
 ...
 *      server.start();
 *
 * Alternatively, you can create an API definition file that is automatically loaded by the API Builder project.
 * For details, see the [API Builder APIs guide](https://docs.axway.com/bundle/API_Builder_allOS_en/page/api_builder_apis.html).
 *
 * ### Invoke an API Endpoint
 *
 * To invoke an API endpoint within the application, use the API Builder instance's [getAPI()](Arrow#getAPI) method.
