 ...
 * ### Components
 *
 * An API Builder project is comprised of several components. You can either define the
 ...
 *
 * For information about the project structure of API Builder projects, see
 * [API Builder guides](https://docs.axway.com/bundle/API_Builder_allOS_en/page/api_builder.html).
 *
 ...
 * #### Connectors
 *
 * {@link Arrow.Connector Connectors} allow an API Builder project to access data stored
 * in an external source.  Connectors are structured like API Builder projects where they have
 ...
 * #### Models
 *
 * {@link Arrow.Model Models} provide an interface for the API Builder project to access
 * data.  By default, the application will generate standardized endpoints for a client to access
 * the data from the API Builder project.
 *
 * #### APIs
 *
 ...
 * an API Builder project, then making requests to the server.
 *
 ...
 * #### Request Sequence
 *
 * When a client makes a request to the API Builder project, API Builder Tools first authenticates the request,
